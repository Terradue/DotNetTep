    ...
    public class WpsProcessOfferingTep : WpsProcessOffering {
        ...
        public string ValidateResult(string json) {
            ...
            try {
                ...
                httpRequest.Timeout = 180000; // 3min, especially for SBAS assertions
        ...
        private ProcessDescriptions GetDescribeProcessFromWps3(Process wps3) {
            ...
            foreach (var inputWps3 in wps3.Inputs) {
                ...
                if (inputWps3.Input.LiteralDataDomains != null) {
                    ...
                    if (literaldomain.ValueDefinition?.AllowedValues != null) input.LiteralData.AllowedValues = literaldomain.ValueDefinition.AllowedValues.ConvertAll(str => (object)(new OpenGis.Wps.ValueType{ Value = str}));
