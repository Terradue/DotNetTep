...
namespace Terradue.Tep {
    ...
    public class DataPackage : RemoteResourceSet, IAtomizable {
        ...
        public override void Store() {
            ...
            if (DomainId == 0 && Owner != null) DomainId = Owner.Domain.Id;
            ...
            try {
                if (isNew){
                    ...
                    else this.Identifier = TepUtility.ValidateIdentifier(this.Identifier);
                }
                base.Store();

                if (isNew && context.AccessLevel == EntityAccessLevel.Administrator && OwnerId != 0) {
