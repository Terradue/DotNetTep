...
namespace Terradue.Tep {
    ...
    public class UserTep : User {
        ...
        public DataPackage GetPrivateDataPackageCatalogueIndex(bool loadItems=true){
            var identifier = "_index_" + TepUtility.ValidateIdentifier(this.Username);//identifier should not have special caracters
            var name = "My Index";
        ...
        public DataPackage GetPrivateDataPackageCatalogueProducts(bool loadItems = true) {
            var identifier = "_products_" + TepUtility.ValidateIdentifier(this.Username);//identifier should not have special caracters
        ...
        public DataPackage GetPrivateDataPackageCatalogueSeries(bool loadItems = true) {
            var identifier = "_series_" + TepUtility.ValidateIdentifier(this.Username);//identifier should not have special caracters
            var name = "My Results";
