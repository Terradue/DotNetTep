...
namespace IO.Swagger.Client
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://virtserver.swaggerhub.com/geoprocessing/WPS/0.01");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://virtserver.swaggerhub.com/geoprocessing/WPS/0.01).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://virtserver.swaggerhub.com/geoprocessing/WPS/0.01")
        {
            ...
            String contentType)
        {
            ...
            // set timeout
            RestClient.Timeout = TimeSpan.FromMilliseconds(50000);
            
            // set user agent
            RestClient.UserAgent = Configuration.UserAgent;

            InterceptRequest(request);
            var response = RestClient.Execute(request).GetAwaiter().GetResult();
