...
INSERT IGNORE INTO config (`name`, `type`, `caption`, `hint`, `value`, `optional`) VALUES ('appExternalPostUserLevel', 'int', 'app External Post User Level', 'appExternalPostUserLevel', '2', '0');
-- RESULT
